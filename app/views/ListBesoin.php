					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><span class="badge bg-info"><?php echo htmlspecialchars((string)$besoin->type_libelle, ENT_QUOTES, 'UTF-8'); ?></span></td>
								<td><strong><?php echo htmlspecialchars((string)($besoin->libelle ?? ''), ENT_QUOTES, 'UTF-8'); ?></strong></td>
								...
								<td>
									...
									<?php elseif ($besoin->quantity_restante < $besoin->quantity): ?>
										<span class="badge bg-warning text-dark"><?php echo (int)$besoin->quantity_restante; ?> (<?= round($pourcentage) ?>%)</span>
									<?php else: ?>
