                                    ...
                                    <div class="list-group-item border-0 border-bottom">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                ...
                                                <small class="text-muted ms-2"><i class="bi bi-calendar"></i> <?= date('d/m/Y', strtotime($don['date_saisie'])) ?></small>
                                            </div>
                                            <span class="badge rounded-pill fs-6" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);">
