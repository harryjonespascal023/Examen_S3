...
$app->set('flight.base_url', '/', );           // Base URL for your app. Change if app is in a subdirectory (e.g., '/myapp/')       // Base URL for your app. Change if app is in a subdirectory (e.g., '/myapp/')
